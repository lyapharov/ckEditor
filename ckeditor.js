...
(function () {
        ...
        CKEDITOR.tools = {
            ...
            parseCssText: function (a, b, c) {
                ...
                a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, c, d) {
                    b && (c = c.toLowerCase(), "font-family" == c && (d = d.replace(/["']/g, "").replace(/\s*,\s*/g, ",")), d = CKEDITOR.tools.trim(d));
                    k[c] = d
                });
                return k
            },
    ...
    CKEDITOR.plugins.add("base64image", {
        lang: "af ar bg bn bs ca cs cy da de el en en-au en-ca en-gb eo es et eu fa fi fo fr fr-ca gl gu he hi hr hu id is it ja ka km ko ku lt lv mk mn ms nb nl no pl pt pt-br ro ru si sk sl sq sr sr-latn sv th tr ug uk vi zh zh-cn".split(" "),
        requires: "dialog",
        icons: "base64image",
        hidpi: !0,
        init: function (a) {
            a.ui.addButton("base64image", {
                label: a.lang.common.image,
                command: "base64imageDialog",
                toolbar: "insert"
            });
            CKEDITOR.dialog.add("base64imageDialog", this.path + "dialogs/base64image.js");
            a.addCommand("base64imageDialog", new CKEDITOR.dialogCommand("base64imageDialog", {
            ...
            a.addMenuItem && (a.addMenuGroup("base64imageGroup"), a.addMenuItem("base64imageItem", {
                label: a.lang.common.image,
    ...
    (function () {
        function l(a) {
            ...
            a = a.replace(/[\n|\t]*/g, "").toLowerCase();
            return !a || "<br>" == a || "<p>&nbsp;<br></p>" == a || "<p><br></p>" == a || "<p>&nbsp;</p>" == a || "&nbsp;" == a || " " == a || "&nbsp;<br>" == a || " <br>" == a ? !0 : !1
        }

        function h(a) {
            var b = a.editor, c = b.editable ? b.editable() : "wysiwyg" == b.mode ? b.document && b.document.getBody() : b.textarea, i = a.listenerData;
            if (c) {
                if ("wysiwyg" == b.mode) {
                    if (CKEDITOR.dialog._.currentTop || !c)return;
                    l(c.getHtml()) && (c.setHtml(i), c.addClass("placeholder"))
                }
                "source" ==
                b.mode && (m ? "mode" == a.name && c.setAttribute("placeholder", i) : l(c.getValue()) && (c.setValue(i), c.addClass("placeholder")))
            }
        }

        function n(a) {
            var a = a.editor, b = a.editable ? a.editable() : "wysiwyg" == a.mode ? a.document && a.document.getBody() : a.textarea;
            if (b) {
                if ("wysiwyg" == a.mode) {
                    if (!b.hasClass("placeholder"))return;
                    b.removeClass("placeholder");
                    if (CKEDITOR.dtd[b.getName()].p) {
                        b.setHtml("<p><br/></p>");
                        var c = new CKEDITOR.dom.range(a.document);
                        c.moveToElementEditablePosition(b.getFirst(), !0);
                        a.getSelection().selectRanges([c])
                    } else b.setHtml(" ")
                }
                "source" ==
                a.mode && b.hasClass("placeholder") && (b.removeClass("placeholder"), b.setValue(""))
            }
        }

        function o(a) {
            return !a ? null : a.getAttribute("lang") || o(a.getParent())
        }

        var m = "placeholder" in document.createElement("textarea");
        CKEDITOR.plugins.add("confighelper", {
            getPlaceholderCss: function () {
                return ".placeholder{ color: #999; }"
            }, onLoad: function () {
                CKEDITOR.addCss && CKEDITOR.addCss(this.getPlaceholderCss())
            }, init: function (a) {
                a.on("mode", function (a) {
                    a.editor.focusManager.hasFocus = !1
                });
                var b = a.element.getAttribute("placeholder") ||
                    a.config.placeholder;
                if (b) {
                    a.addCss && a.addCss(this.getPlaceholderCss());
                    var c = CKEDITOR.document.getHead().append("style");
                    c.setAttribute("type", "text/css");
                    CKEDITOR.env.ie && 11 > CKEDITOR.env.version ? c.$.styleSheet.cssText = "textarea.placeholder { color: #999; font-style: italic; }" : c.$.innerHTML = "textarea.placeholder { color: #999; font-style: italic; }";
                    a.on("getData", function (b) {
                        var j = a.editable ? a.editable() : "wysiwyg" == a.mode ? a.document && a.document.getBody() : a.textarea;
                        j && j.hasClass("placeholder") &&
                        (b.data.dataValue = "")
                    });
                    a.on("setData", function (b) {
                        if (!CKEDITOR.dialog._.currentTop && !("source" == a.mode && m)) {
                            var j = a.editable ? a.editable() : "wysiwyg" == a.mode ? a.document && a.document.getBody() : a.textarea;
                            j && (l(b.data.dataValue) ? h(b) : j.hasClass("placeholder") && j.removeClass("placeholder"))
                        }
                    });
                    a.on("blur", h, null, b);
                    a.on("mode", h, null, b);
                    a.on("contentDom", h, null, b);
                    a.on("focus", n);
                    a.on("beforeModeUnload", n)
                }
                if ((b = a.config.contentsLanguage || o(a.element)) && !a.config.scayt_sLang)localStorage && localStorage.removeItem("scayt_0_lang"),
                    a.config.scayt_sLang = {
                        en: "en_US",
                        "en-us": "en_US",
                        "en-gb": "en_GB",
                ...
                CKEDITOR.on("dialogDefinition", function (b) {
                    if (a == b.editor) {
                        var c = b.data.name, b = b.data.definition, g, d, e, f, k;
                        "tableProperties" == c && "table" == c;
                        !("removeDialogFields" in a._) && a.config.removeDialogFields && (a._.removeDialogFields = i(a.config.removeDialogFields));
                        if (a._.removeDialogFields && (g = a._.removeDialogFields[c]))for (e in g) {
                            f = g[e];
                            k = b.getContents(e);
                            for (d = 0; d < f.length; d++)k.remove(f[d])
                        }
                        !("hideDialogFields" in a._) &&
                        a.config.hideDialogFields && (a._.hideDialogFields = i(a.config.hideDialogFields));
                        if (a._.hideDialogFields && (g = a._.hideDialogFields[c]))for (e in g) {
                            f = g[e];
                            k = b.getContents(e);
                            for (d = 0; d < f.length; d++)k.get(f[d]).hidden = !0
                        }
                        if (a.config.dialogFieldsDefaultValues && (g = a.config.dialogFieldsDefaultValues[c]))for (e in g) {
                            f = g[e];
                            k = b.getContents(e);
                            for (var h in f)(c = k.get(h)) && (c["default"] = f[h])
                        }
                    }
                })
            }
    ...
    CKEDITOR.config.fontSize_sizes = "6/6pt;7/7pt;8/8pt;10/10pt;11/11pt;12/12pt;14/14pt;16/16pt;18/18pt;20/20pt;22/22pt;24/24pt;26/26pt;28/28pt;36/36pt;48/48pt;";
    ...
    (function () {
        function g(a) {
            var d = a.listenerData && a.listenerData.editor, b = a.data.$.clipboardData, c = !1, e = /^image/;
            if (b)return Array.prototype.forEach.call(b.types, function (a, f) {
    ...
    (function (g, H) {
        function v(a) {
            var b, c, d;
            if (a.nodeType === t.dom.ELEMENT_NODE) {
                var e = a.childNodes;
                for (c = 0; c < e.length; ++c)if (d = e[c], v(d), b = d.nodeName.toLowerCase(), b === k.insertTag || b === k.deleteTag) {
                    for (; d.firstChild;)a.insertBefore(d.firstChild, d);
                    a.removeChild(d)
                }
            }
            b = a.nodeName.toLowerCase();
            return "ins" === b || "del" === b ? jQuery.makeArray(a.childNodes) : [a]
        }
        ...
        function w(a) {
            return a && a.$ && "function" === typeof a.getDocument ?
                a.$ : a
        }

        function x(a) {
            for (var b = p.length; b--;)if (p[b].editor === a)return b;
            return -1
        }
        ...
        function z(a) {
            return (a = y(a)) && a.plugin
        }

        function l(a, b) {
            var c = a, d, c = null === c || "undefined" === typeof c ? "" : String(c);
            d = "0";
            for (var e = d.length, f = c.length; f < b; f += e)c = d + c;
            return c
        }

        function A(a, b) {
            var c = new Date, d = c.getDate(), e = c.getMonth(), f = c.getFullYear(), g = typeof a;
            if ("string" === g || "number" === g)a = new Date(a);
            if (d == a.getDate() && e == a.getMonth() && f == a.getFullYear()) {
                c = Math.floor((c.getTime() -
                    a.getTime()) / 6E4);
                if (1 > c)return b.NOW;
                if (2 > c)return b.MINUTE_AGO;
                if (60 > c)return b.MINUTES_AGO.replace("xMinutes", c);
                d = a.getHours();
                c = a.getMinutes();
                return b.AT + " " + l(d, 2) + ":" + l(c, 2, "0")
            }
            return f == a.getFullYear() ? b.ON + " " + b.LITE_LABELS_DATE(a.getDate(), a.getMonth()) : b.ON + " " + b.LITE_LABELS_DATE(a.getDate(), a.getMonth(), a.getFullYear())
        }

        function n() {
            var a = window.console;
            a && a.error && a.error.apply(a, [].slice.call(arguments))
        }

        function B(a, b) {
            if (g.env.ie)return C(a, b);
            try {
                return a.document.$.execCommand(b,
                    !1, null)
            } catch (c) {
                return !1
            }
        ...
        function C(a, b) {
            ...
            d.on(b, f);
            c = (7 < g.env.version ? c.$ : c.$.selection.createRange()).execCommand(b, !1);
            d.removeListener(b, f);
            return c || e
        }
        ...
        var J = {
            ...
            deleteTag: "del", insertTag: "ins", deleteClass: "ice-del", insertClass: "ice-ins", attributes: {
                changeId: "data-cid", userId: "data-userid", userName: "data-username", sessionId: "data-session-id",
                changeData: "data-changedata", time: "data-time", lastTime: "data-last-change-time"
            }, stylePrefix: "ice-cts", preserveOnPaste: "p", css: "css/lite.css"
        }, r = "%a by %u %t", t = null, K = /^[\s\r\n]*$/, u = [{
            regex: /[\s]*title=\"[^\"]+\"/g,
            replace: ""
        }, {
            regex: /[\s]*data-selected=\"[^\"]+\"/g,
            replace: ""
        }], p = [], D = [g.CTRL + 88, g.CTRL + 120, g.SHIFT + 46], E = !1, F = function () {
            var a = parseFloat(g.version);
            E = isNaN(a) || 4.4 > a;
            F = function () {
            }
        };
        g.plugins.add("lite", {
            ...
            hidpi: !0, lang: ["en", "de"], _scriptsLoaded: null, init: function (a) {
                F();
                if (!y(a)) {
                    var b = this.path, c = new G(b), d = g.tools.extend({}, a.config.lite || {}), e = d.tooltips;
                    void 0 === e && (e = !0);
                    !0 === e && (e = J);
                    d.tooltips = e;
                    p.push({plugin: c, editor: a});
                    c.init(a, d);
                    a.on("destroy", function (a) {
                        a = x(a);
                        0 <= a && p.splice(a, 1)
                    }.bind(this));
                    if (this._scriptsLoaded)c._onScriptsLoaded(); else if (!1 !== this._scriptsLoaded) {
                        this._scriptsLoaded = !1;
                        var f = "function" === typeof jQuery, m = this;
                        a = d.jQueryPath || "js/jquery.min.js";
                        for (var h = (d.includeType ?
                                d["includes_" + d.includeType] : d.includes) || ["lite-includes.js"], h = h.slice(), d = 0, c = h.length; d < c; ++d)h[d] = b + h[d];
                        f || h.splice(0, 0, this.path + a);
                        e.path && h.push(this.path + e.path);
                        var q = function () {
                            if (1 > h.length)m._scriptsLoaded = !0, t = H.ice, f || jQuery.noConflict(), jQuery.each(p, function (a, b) {
                                b.plugin._onScriptsLoaded()
                            }); else {
                                var a = h.shift();
                                g.scriptLoader.load(a, function () {
                                    q()
                                }, m)
                            }
                        };
                ...
                return z(a)
            }, startNewSession: function (a) {
                (a = z(a)) ? a.startNewSession() : n("startNewSession: plugin not found")
            }
        });
        var G = function (a) {
            this.path = a
        ...
        G.prototype = {
            init: function (a, b) {
                function c(b) {
                    a.addCommand(b.command, {exec: b.exec.bind(m), readOnly: b.readOnly || !1});
                    if (b.title && 0 <= f.indexOf(b.command)) {
                        var c = m._commandNameToUIName(b.command);
                        a.ui.addButton(c, {label: b.title, command: b.command, toolbar: "lite"});
                        !1 !== b.trackingOnly && m._liteCommandNames.push(b.command)
                    }
                }
                ...
                this._editor = a;
                this._domLoaded = !1;
                this._tracker = this._editor = null;
                this._isVisible = !0;
                this._liteCommandNames = [];
                this._canAcceptReject = !0;
                this._removeBindings = [];
                r || (r = "%a " + d.lite.BY + " %u %t");
                a.ui.addToolbarGroup("lite");
                this._setPluginFeatures(a, k);
                this._changeTimeout = null;
                this._notifyChange = this._notifyChange.bind(this);
                this._notifyTextChange = this._notifyTextChange.bind(this);
                this._config = b;
                var e = !0 === b.acceptRejectInReadOnly, e = [{
                    command: "lite-toggletracking",
                    exec: this._onToggleTracking,
                    title: d.TOGGLE_TRACKING,
                    trackingOnly: !1
                }, {command: "lite-toggleshow", exec: this._onToggleShow, title: d.TOGGLE_SHOW, readOnly: !0}, {
                    command: "lite-acceptall",
                    exec: this._onAcceptAll, title: d.ACCEPT_ALL, readOnly: e
                }, {
                    command: "lite-rejectall",
                    exec: this._onRejectAll,
                    title: d.REJECT_ALL,
                    readOnly: e
                }, {
                    command: "lite-acceptone",
                    exec: this._onAcceptOne,
                    title: d.ACCEPT_ONE,
                    readOnly: e
                }, {
                    command: "lite-rejectone",
                    exec: this._onRejectOne,
                    title: d.REJECT_ONE,
                    readOnly: e
                }, {command: "lite-toggletooltips", exec: this._onToggleTooltips, readOnly: !0}];
                this._isTracking = !1 !== b.isTracking;
                this._trackingState = null;
                this._eventsBounds = !1;
                a.on("contentDom", function (a) {
                    this._onDomLoaded(a)
                }.bind(this));
                a.on("dataReady", function (a) {
                    this._onAfterSetData(a)
                }.bind(this));
                for (var f = b.commands || "lite-toggletracking lite-toggleshow lite-acceptall lite-rejectall lite-acceptone lite-rejectone".split(" "), m = this, h = 0, q = e.length; h < q; ++h)c(e[h]);
                !1 !== b.contextMenu && (a.addMenuItems && (a.addMenuGroup("lite", 50), e = {}, 0 <= f.indexOf("lite-acceptone") && (e["lite-acceptone"] = {
                    label: d.ACCEPT_ONE,
                    command: "lite-acceptone",
                    group: "lite",
                    order: 1
                }), 0 <= f.indexOf("lite-rejectone") && (e["lite-rejectone"] = {
                    label: d.REJECT_ONE, command: "lite-rejectone",
                    group: "lite", order: 2
                }), a.addMenuItems(e)), a.contextMenu && a.contextMenu.addListener(function (a) {
                    return a && this._tracker && this._tracker.currentChangeNode(a) ? (a = {}, a["lite-acceptone"] = g.TRISTATE_OFF, a["lite-rejectone"] = g.TRISTATE_OFF, a) : null
                }.bind(this)))
            }, toggleTracking: function (a, b) {
                "boolean" === typeof b && (b = {notify: b});
                b = b || {};
                var c = void 0 === a ? !this._isTracking : a, d = this._editor, e = this._editor.lang.lite, f = b && b.force;
                if (!c && this._isTracking && !f && this._tracker.countChanges({verify: !0}))return window.alert(e.PENDING_CHANGES);
                this._isTracking = c;
                this._setCommandsState(this._liteCommandNames, c ? g.TRISTATE_OFF : g.TRISTATE_DISABLED);
                this._updateTrackingState();
                this.toggleShow(c, !1);
                this._setCommandsState("lite-toggletracking", c ? g.TRISTATE_ON : g.TRISTATE_OFF);
                (f = d.ui.get(this._commandNameToUIName("lite-toggletracking"))) && this._setButtonTitle(f, c ? e.STOP_TRACKING : e.START_TRACKING);
                !1 !== b.notify && d.fire("lite:tracking", {tracking: c, lite: this})
            }, toggleShow: function (a, b) {
                var c = "undefined" === typeof a ? !this._isVisible : a, d = this._editor.lang.lite;
                this._isVisible = c;
                this._isTracking && this._setCommandsState("lite-toggleshow", c ? g.TRISTATE_ON : g.TRISTATE_OFF);
                this._tracker.setShowChanges(c && this._isTracking);
                var e = this._editor.ui.get(this._commandNameToUIName("lite-toggleshow"));
                e && this._setButtonTitle(e, c ? d.HIDE_TRACKED : d.SHOW_TRACKED);
                !1 !== b && this._editor.fire("lite:showHide", {show: c, lite: this})
            }, isVisible: function () {
                return this._isVisible
            }, isTracking: function () {
                return this._isTracking
            }, acceptAll: function (a) {
                this._tracker.acceptAll(a);
                this._cleanup();
                this._editor.fire("lite:accept", {lite: this, options: a})
            }, rejectAll: function (a) {
                this._tracker.rejectAll(a);
                this._cleanup();
                this._editor.fire("lite:reject", {lite: this, options: a})
            }, setUserInfo: function (a) {
                a = a || {};
                this._config.userId = String(a.id);
                this._config.userName = a.name || "";
                this._tracker && this._tracker.setCurrentUser({id: this._config.userId, name: this._config.userName})
            }, getUserInfo: function () {
                return this._tracker ? this._tracker.getCurrentUser() : {name: "", id: ""}
            }, countChanges: function (a) {
                return this._tracker &&
                    this._tracker.countChanges(a) || 0
            }, enableAcceptReject: function (a) {
                this._canAcceptReject = Boolean(a);
                this._onIceChange()
            }, filterIceElement: function (a) {
                if (!a)return !0;
                try {
                    if (a.hasClass(k.insertClass) || a.hasClass(k.deleteClass))return !1
                } catch (b) {
                }
                return !0
            }, startNewSession: function () {
                var a = new Date;
                this._sessionId = String.fromCharCode(65 + Math.round(26 * Math.random())) + a.getDate() + a.getDay() + a.getHours() + a.getMinutes() + a.getMilliseconds();
                this._tracker && this._tracker.setSessionId(this._sessionId)
            }, getCleanMarkup: function (a) {
                if (null ===
                    a || void 0 === a)a = this._editor && this._editor.getData() || "";
                for (var b = u.length - 1; 0 <= b; --b)a = a.replace(u[b].regex, u[b].replace);
                return a
            }, getCleanText: function () {
                var a = this._getDocument();
                if (!a)return "";
                var b = this._editor.getData(), a = a.createElement("DIV");
                a.innerHTML = b;
                b = [];
                b.push("");
                var c = this._tracker.getDeleteClass();
                this._getCleanText(a, b, c);
                a = b.join("\n");
                return a = a.replace(/&nbsp(;)?/ig, " ")
            }, acceptChange: function (a) {
                (a = w(a)) && this._tracker && (this._tracker.acceptChange(a), this._cleanup(), this._editor.fire("lite:accept",
                    {lite: this}), this._onSelectionChanged(null))
            }, rejectChange: function (a) {
                (a = w(a)) && this._tracker && (this._tracker.rejectChange(a), this._cleanup(), this._editor.fire("lite:reject", {lite: this}), this._onSelectionChanged(null))
            }, getChanges: function (a) {
                return this._tracker && this._tracker.getChanges(a) || {}
            }, _getCleanText: function (a, b, c) {
                var d = a.getAttribute("class");
                if (!(d && 0 <= d.indexOf(c))) {
                    if (d = a.nodeName && "BR" === a.nodeName.toUpperCase() || "block" === jQuery(a).css("display"))K.test(b[b.length - 1]) ? b[b.length -
                    1] = "" : b.push("");
                    for (a = a.firstChild; a; a = a.nextSibling) {
                        var e = a.nodeType;
                        3 == e ? b[b.length - 1] += String(a.nodeValue) : 1 != e && 9 != e && 11 != e || this._getCleanText(a, b, c)
                    }
                    d && b.push("")
                }
            }, _onDomLoaded: function (a) {
                this._domLoaded = !0;
                this._editor = a.editor;
                a = this._editor.editable();
                a.attachListener(a, "mousedown", this._onMouseDown, this, null, 1);
                a.attachListener(a, "keypress", this._onKeyPress, this, null, 1);
                this._hideTooltip();
                this._onReady()
            }, _onScriptsLoaded: function () {
                this._scriptsLoaded = !0;
                this._onReady()
            }, _loadCSS: function (a,
                                   b) {
                function c(b, c) {
                    if (b) {
                        var e = jQuery(d).find("#" + c);
                        e.length || (e = a.createElement("link"), e.setAttribute("rel", "stylesheet"), e.setAttribute("type", "text/css"), e.setAttribute("id", c), e.setAttribute("href", f + b), d.appendChild(e))
                    }
                }

                var d = a.getElementsByTagName("head")[0], e = b.cssPath, f = this.path;
                !1 !== e && c(e || b.defaultCssPath, "__lite__css__");
                this._config.tooltips.cssPath && c(this._config.tooltips.cssPath, "__lite_tt_css__")
            }, _onReady: function () {
                this._scriptsLoaded && this._domLoaded && setTimeout(this._afterReady.bind(this),
                    5)
            }, _getBody: function () {
                try {
                ...
                var a = this._editor, b = a.document.$, c = this._getBody(), d = this._config, e = d && d.debug || {};
                this._loadCSS(b, {cssPath: d.cssPath, defaultCssPath: "css/lite.css"});
                if (!this._eventsBounds) {
                    this._eventsBounds = !0;
                    b = this._onPaste.bind(this);
                    a.on("afterCommandExec", this._onAfterCommand.bind(this));
                    a.on("beforeCommandExec",
                        this._onBeforeCommand.bind(this));
                    if (this._config.handlePaste)a.on("paste", b, null, null, 1);
                    a.on("beforeGetData", this._onBeforeGetData.bind(this));
                    a.on("beoreUndoImage", this._onBeforeGetData.bind(this));
                    a.on("insertHtml", b, null, null, 1);
                    a.on("insertText", b, null, null, 1);
                    a.on("insertElement", b, null, null, 1);
                    a.on("mode", this._onModeChange.bind(this), null, null, 1);
                    a.on("readOnly", this._onReadOnly.bind(this))
                }
                this._tracker && c != this._tracker.getContentElement() && (this._tracker.stopTracking(!0), jQuery(this._tracker).unbind(),
                    this._tracker = null);
                if (!this._tracker) {
                    c = {
                        element: c,
                        mergeBlocks: !1,
                        currentUser: {id: d.userId || "", name: d.userName || ""},
                        userStyles: d.userStyles,
                        changeTypes: {
                            insertType: {tag: k.insertTag, alias: k.insertClass, action: "Inserted"},
                            deleteType: {tag: k.deleteTag, alias: k.deleteClass, action: "Deleted"}
                        },
                        hostMethods: {
                            getHostRange: this._getHostRange.bind(this),
                            getHostRangeData: this._getHostRangeData.bind(this),
                            makeHostElement: function (a) {
                                return new g.dom.element(a)
                            },
                    ...
                    e.log && (c.hostMethods.logError = n);
                    c.tooltips = d.tooltips.show;
                    if (c.tooltips && (e = this._hideTooltip.bind(this), c.hostMethods.showTooltip = this._showTooltip.bind(this), c.hostMethods.hideTooltip = e, c.hostMethods.beforeDelete = c.hostMethods.beforeInsert = e, d.tooltips.classPath)) {
                        try {
                            this._tooltipsHandler = new window[d.tooltips.classPath], c.tooltipsDelay = d.tooltips.delay
                        } catch (f) {
                        }
                        this._tooltipsHandler ? this._tooltipsHandler.init(d.tooltips) :
                            n("Unable to create tooltip handler", d.tooltips.classPath)
                    }
                    jQuery.extend(c, k);
                    this._tracker = new t.InlineChangeEditor(c);
                    try {
                        this._tracker.startTracking(), this.toggleTracking(this._isTracking, !1), this._updateTrackingState(), jQuery(this._tracker).on("change", this._onIceChange.bind(this)).on("textChange", this._onIceTextChanged.bind(this)), a.fire("lite:init", {lite: this}), this._onSelectionChanged(null), this._onIceChange(null)
                    } catch (m) {
                        n("ICE plugin init:", m)
                    }
                }
            ...
            _onToggleTracking: function () {
                ...
                var a = this._tracker.currentChangeNode();
                return this.acceptChange(a)
            }, _onRejectOne: function () {
                var a = this._tracker.currentChangeNode();
                return this.rejectChange(a)
            }, _onToggleTooltips: function () {
                this._tracker && this._tracker.toggleTooltips()
            }, _cleanup: function () {
                var a = this._getBody();
                jQuery(a).find(self.insertSelector + ":empty," + self.deleteSelector +
                    ":empty").remove();
                this._onSelectionChanged(null)
            }, _setButtonTitle: function (a, b) {
                jQuery("#" + a._.id).attr("title", b)
            }, _onAfterCommand: function (a) {
                a = this._tracker && this._isTracking && a.data && a.data.name;
                "undo" !== a && "redo" !== a || this._tracker.reload()
            }, _onBeforeCommand: function (a) {
                a = this._tracker && this._tracker.isTracking() && a.data && a.data.name;
                "cut" === a ? B(this._editor, "copy") && this._tracker.prepareToCut() : "copy" === a && B(this._editor, "copy") && this._tracker.prepareToCopy()
            }, _onModeChange: function (a) {
                this._updateTrackingState();
                setTimeout(this._onIceChange.bind(this), 0)
            }, _onKeyPress: function (a) {
                var b = a && a.data && a.data.getKeystroke();
                0 <= D.indexOf(b) && a.stop()
            }, _onKeyDown: function (a) {
                this._tracker && this._tracker.isTracking() && 0 <= D.indexOf(a.data.keyCode) && this._tracker.tryToCut() && a.stop()
                ...
                this._tracker && this._tracker.reload()
            }, _onReadOnly: function () {
                this._updateTrackingState()
            },
            _updateTrackingState: function () {
                if (this._tracker) {
                    var a = this._isTracking && "wysiwyg" === this._editor.mode && !this._editor.readOnly;
                    if (a !== this._trackingState) {
                        this._trackingState = a;
                        this._tracker.toggleChangeTracking(a);
                        for (var b = this._removeBindings.length - 1; 0 <= b; --b)this._removeBindings[b].removeListener();
                        this._removeBindings = [];
                        this._tracker.unlistenToEvents();
                        a && (a = this._onSelectionChanged.bind(this), b = this._editor.editable(), E ? this._tracker.listenToEvents() : this._removeBindings.push(this._editor.on("key",
                            function (a) {
                                return this._tracker ? (a = a.data.domEvent && a.data.domEvent.$) ? this._tracker.handleEvent(a) : !0 : !0
                            }.bind(this))), this._removeBindings.push(b.on("keyup", this._onSelectionChanged.bind(this, null, !1))), this._removeBindings.push(b.on("click", a)), this._removeBindings.push(this._editor.on("selectionChange", a)))
                    }
                }
            }, _onPaste: function (a) {
                if (!this._tracker || !this._isTracking || !a)return !0;
                var b = a.data || {}, c = null, d = ["[data-track-changes-ignore]"].concat(this._config.ignoreSelectors || []), e = window.jQuery,
                    f = "insertElement" == a.name && b.$;
                if (b) {
                    "string" === typeof b && (b = {dataValue: b, type: "text"});
                    if (b.dataValue && "html" === (b.type || b.mode))try {
                        f = jQuery(b.dataValue)
                    } catch (g) {
                    }
                    if ("string" === typeof b.dataValue)try {
                        var h = this._editor.document.$.createElement("div");
                        h.innerHTML = String(b.dataValue);
                        h = this._tracker.getCleanDOM(h);
                        if (!h.innerHTML)return !0;
                        c = jQuery.makeArray(h.childNodes)
                    } catch (q) {
                        n("ice plugin paste:", q)
                    } else if (f)c = [f]; else return !0;
                    c && d.length && (c = c.filter(function (a) {
                        a:{
                            a = e(a);
                            var b, c = d && d.length;
                            if (a && c)for (b = 0; b < c; ++b)if (a.is(d[b])) {
                                a = !0;
                                break a
                            }
                            a = !1
                    ...
                    c && c.length && (c = I(c), b = this._editor.focusManager.hasFocus, this._beforeInsert(), this._tracker.insert({nodes: c}), this._afterInsert(), b && this._editor.editable().focus(), a.stop());
                    return !0
                }
            }, _setCommandsState: function (a, b) {
                "string" === typeof a && (a = a.split(","));
                for (var c = a.length - 1; 0 <= c; --c) {
                    var d = this._editor.getCommand(a[c]);
                    d && d.setState(b)
                }
            }, _onSelectionChanged: function (a, b) {
                var c = this._isTracking && this._tracker && this._tracker.isInsideChange(null,
                    null, b) && this._canAcceptReject ? g.TRISTATE_OFF : g.TRISTATE_DISABLED;
                this._setCommandsState(["lite-acceptone", "lite-rejectone"], c)
            }, _onIceChange: function (a) {
                var b = this._isTracking && this._tracker && this._tracker.hasChanges() && this._canAcceptReject ? g.TRISTATE_OFF : g.TRISTATE_DISABLED;
                this._setCommandsState(["lite-acceptall", "lite-rejectall"], b);
                this._onSelectionChanged();
                a && this._triggerChange()
            }, _onIceTextChanged: function (a) {
                ...
                this._changeTimeout = null;
                this._editor.fire("lite:change", {lite: this})
            }, _notifyTextChange: function () {
                this._changeTimeout = null;
                this._editor.fire("change", {lite: this})
            }, _processContent: function () {
                function a(a, b) {
                    var d = a.parentNode, e = g.createElement(b);
                    c.each(a.attributes, function (a, b) {
                        e.setAttribute(b.name, b.value)
                    });
                    e.className = a.className || "";
                    c(a).contents().appendTo(e);
                    d.insertBefore(e, a);
                    d.removeChild(a)
                }

                var b = this._getBody(),
                    c = window.jQuery, d = k.insertTag, e = k.deleteTag, f, g;
                b && (g = b.ownerDocument, "span" !== d && (f = c(b).find("span." + k.insertClass), f.each(function (b, c) {
                    a(c, d)
                })), "span" !== e && (f = c(b).find("span." + k.deleteClass), f.each(function (b, c) {
                    a(c, e)
                })))
            }, _commandNameToUIName: function (a) {
                return a.replace(".", "_")
            }, _setPluginFeatures: function (a, b) {
                function c() {
                    var a = ["title"], c;
                    for (c in b.attributes)if (b.attributes.hasOwnProperty(c)) {
                        var d = b.attributes[c];
                        "string" === typeof d && 0 === d.indexOf("data-") && a.push(d)
                    }
                    return a
                }
                ...
                if (a && a.filter && a.filter.addFeature)try {
                    var e, f;
                    e = {};
                    f = {};
                    f.classes = d([b.deleteClass, b.insertClass, b.stylePrefix + "*"]);
                    f.attributes = d(c());
                    e[b.insertTag] = f;
                    e[b.deleteTag] = g.tools.clone(f);
                    e.br = g.tools.clone(f);
                    e.br.propertiesOnly = !0;
                    e.span = g.tools.clone(f);
                    a.filter.addFeature({name: "lite-features", allowedContent: e})
                } catch (k) {
                    n(k)
                }
            }, _setHostRange: function (a) {
                var b = this._editor && this._editor.getSelection();
                b && b.selectRanges([a])
                ...
                try {
                    g.env.ie ? C(this._editor, "copy") : this._editor.document.$.execCommand("copy", !1, null)
                } catch (a) {
                    n(a)
                }
            }, _getHostRange: function () {
                var a = this._editor && this._editor.getSelection();
                return (a = a && a.getRanges()) && a[0] || null
            }, _getHostRangeData: function (a) {
                return (a = a || this._getHostRange()) ? {
                    startContainer: a.startContainer && a.startContainer.$,
                    endContainer: a.endContainer && a.endContainer.$,
                    startOffset: a.startOffset,
                    endOffset: a.endOffset
                } : null
            }, _showTooltip: function (a, b) {
                var c = this._config.tooltips;
                if (c.events)return this._editor && this._editor.fire("lite:hover-in", {
                        lite: this,
                        node: a,
                        changeId: b.changeId
                    });
                c.show && (c = this._makeTooltipTitle(b), this._tooltipsHandler ? (this._tooltipsHandler.hideAll(this._getBody()), this._tooltipsHandler.showTooltip(a, c, this._editor.container.$)) : a.setAttribute("title", c))
            }, _hideTooltip: function (a) {
                if (this._config.tooltips.events)return this._editor && this._editor.fire("lite:hover-out",
                        {lite: this, node: a});
                this._tooltipsHandler ? a ? this._tooltipsHandler.hideTooltip(a) : this._tooltipsHandler.hideAll(this._getBody()) : this._tracker && (a ? a.removeAttribute("title") : (a = this._tracker.getIceNodes()) && a.removeAttr("title"))
            }, _beforeInsert: function () {
                this._editor.fire("saveSnapshot")
            }, _afterInsert: function () {
                this._editor.getSelection().scrollIntoView()
            }, _makeTooltipTitle: function (a) {
                var b = this._config.tooltipTemplate || r, c = new Date(a.time), d = new Date(a.lastTime), e = this._editor.lang.lite, b = b.replace(/%a/g,
                    "insert" === a.type ? e.CHANGE_TYPE_ADDED : e.CHANGE_TYPE_DELETED), b = b.replace(/%t/g, A(c, e)), b = b.replace(/%u/g, a.userName), b = b.replace(/%dd/g, l(c.getDate(), 2)), b = b.replace(/%d/g, c.getDate()), b = b.replace(/%mm/g, l(c.getMonth() + 1, 2)), b = b.replace(/%m/g, c.getMonth() + 1), b = b.replace(/%yy/g, l(c.getYear() - 100, 2)), b = b.replace(/%y/g, c.getFullYear()), b = b.replace(/%nn/g, l(c.getMinutes(), 2)), b = b.replace(/%n/g, c.getMinutes()), b = b.replace(/%hh/g, l(c.getHours(), 2)), b = b.replace(/%h/g, c.getHours()), b = b.replace(/%T/g, A(d,
                    e)), b = b.replace(/%DD/g, l(d.getDate(), 2)), b = b.replace(/%D/g, d.getDate()), b = b.replace(/%MM/g, l(d.getMonth() + 1, 2)), b = b.replace(/%M/g, d.getMonth() + 1), b = b.replace(/%YY/g, l(d.getYear() - 100, 2)), b = b.replace(/%Y/g, d.getFullYear()), b = b.replace(/%NN/g, l(d.getMinutes(), 2)), b = b.replace(/%N/g, d.getMinutes()), b = b.replace(/%HH/g, l(d.getHours(), 2));
                return b = b.replace(/%H/g, d.getHours())
            }
        }
    ...
    CKEDITOR.config.plugins = 'basicstyles,dialogui,dialog,clipboard,panel,floatpanel,menu,contextmenu,button,toolbar,elementspath,enterkey,entities,popup,filebrowser,floatingspace,listblock,richcombo,format,horizontalrule,htmlwriter,indent,indentlist,fakeobjects,link,list,maximize,pastetext,pastefromword,removeformat,showborders,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,tabletools,undo,wsc,base64image,confighelper,divarea,font,justify,pastebase64,lite,sharedspace';
    ...
    (function () {
        ...
        if (CKEDITOR.env.hidpi) setIcons('bold,0,,italic,24,,strike,48,,subscript,72,,superscript,96,,underline,120,,copy-rtl,144,,copy,168,,cut-rtl,192,,cut,216,,paste-rtl,240,,paste,264,,horizontalrule,288,,indent-rtl,312,,indent,336,,outdent-rtl,360,,outdent,384,,anchor-rtl,408,,anchor,432,,link,456,,unlink,480,,bulletedlist-rtl,504,,bulletedlist,528,,numberedlist-rtl,552,,numberedlist,576,,maximize,600,,pastetext-rtl,624,,pastetext,648,,pastefromword-rtl,672,,pastefromword,696,,removeformat,720,,source-rtl,744,,source,768,,specialchar,792,,scayt,816,,table,840,,redo-rtl,864,,redo,888,,undo-rtl,912,,undo,936,,spellchecker,960,,base64image,984,,justifyblock,1008,,justifycenter,1032,,justifyleft,1056,,justifyright,1080,,lite-acceptall,1104,,lite-acceptone,1128,,lite-rejectall,1152,,lite-rejectone,1176,,lite-toggleshow,1200,,lite-toggletracking,1224,', 'icons_hidpi.png'); else setIcons('bold,0,auto,italic,24,auto,strike,48,auto,subscript,72,auto,superscript,96,auto,underline,120,auto,copy-rtl,144,auto,copy,168,auto,cut-rtl,192,auto,cut,216,auto,paste-rtl,240,auto,paste,264,auto,horizontalrule,288,auto,indent-rtl,312,auto,indent,336,auto,outdent-rtl,360,auto,outdent,384,auto,anchor-rtl,408,auto,anchor,432,auto,link,456,auto,unlink,480,auto,bulletedlist-rtl,504,auto,bulletedlist,528,auto,numberedlist-rtl,552,auto,numberedlist,576,auto,maximize,600,auto,pastetext-rtl,624,auto,pastetext,648,auto,pastefromword-rtl,672,auto,pastefromword,696,auto,removeformat,720,auto,source-rtl,744,auto,source,768,auto,specialchar,792,auto,scayt,816,auto,table,840,auto,redo-rtl,864,auto,redo,888,auto,undo-rtl,912,auto,undo,936,auto,spellchecker,960,auto,base64image,984,auto,justifyblock,1008,auto,justifycenter,1032,auto,justifyleft,1056,auto,justifyright,1080,auto,lite-acceptall,1104,auto,lite-acceptone,1128,auto,lite-rejectall,1152,auto,lite-rejectone,1176,auto,lite-toggleshow,1200,auto,lite-toggletracking,1224,auto', 'icons.png');
    })();
