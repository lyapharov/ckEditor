CKEDITOR.editorConfig = function( config ) {
	...
	CKEDITOR.config.coreStyles_bold = { element: 'span', styles: { 'font-weight': 'bold' }, overrides: 'strong' };
	CKEDITOR.config.coreStyles_italic = { element: 'span', styles: { 'font-style': 'italic' }, overrides: 'em' };
